...
The primary area of data science I improved upon as a student through this class is in how I optimize my processes. The first aspect I improved in this respect is by reducing the number of single use variables Making sure the order of operations reduces single use variables and also allows for reuse of modified datasets
